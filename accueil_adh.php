...
if(isset($_GET['page'])){
    ...
    switch($page){
        case 'inscription': require_once('inscription_adh.php');break;
        case 'connexion': require_once('connexion_adh.php');break;
        case 'liste': require_once('liste_jardins.php');break;
        case 'profil': require_once('profil_adh.php');break;
        ...
        default: echo '<p class=erreur> Problème ! Vous avez entré une valeur inconnue.</p>';
    }
}
else{
